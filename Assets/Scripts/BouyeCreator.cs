...
//				bouyesLeft [i, lane / 2].transform.position = new Vector3 (0, 0F, -3.5f*lane);
	...
	void Bark(){
		...
		//print (x);
//		bouyesRight[0].transform.position = new Vector3 (5.0f * (x/5+1), 0F, 3.5f);
//		print (x);
//		print (nLanes);
		for (int lane = 1; lane < nLanes; lane += 2) {
			for (int i = 0; i < nBouyes; i++) {
...
//				print ("bark");
			//	bouyesRight [i, lane / 2].transform.position = new Vector3 (5.0f * i-5*(nBouyes/2.0f) +5*x, 0F, 3.5f*lane);
				//bouyesLeft [i, lane / 2].transform.position = new Vector3 (5.0f *  i-5*(nBouyes/2.0f) +5*x, 0F, -3.5f*lane);
...
//				bouyesRight[i, lane / 2].transform.position = new Vector3 (5.0f * i - 5 * 5, 0F, 3.5f * lane);
//				bouyesLeft[i, lane / 2].transform.position = new Vector3 (5.0f * i - 5 * 5.0f, 0F, -3.5f * lane);
			}
